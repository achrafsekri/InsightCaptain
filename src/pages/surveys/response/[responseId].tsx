...
import { getSurvey, getSurveyResponseById } from "../../../lib/apiCalls";
import { type SurveyAnswer } from "@prisma/client";
...
const Index = () => {
  ...
  const {
    ...
    error,
    refetch,
  } = useQuery<SurveyAnswer>(["answer"], () =>
    getSurveyResponseById(String(responseId))
  );
